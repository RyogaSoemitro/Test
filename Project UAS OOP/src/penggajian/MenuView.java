...
public class MenuView extends JFrame {
	...
	public MenuView() {
		...
		btnViewPegawai.setBounds(43, 35, 160, 23);
		...
		btnViewGaji.setBounds(227, 35, 160, 23);
		contentPane.add(btnViewGaji);
		JButton btnViewWilayahKerja = new JButton("View Wilayah");
		btnViewWilayahKerja.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ViewWilayah vw = new ViewWilayah();
				vw.setVisible(true);
			}
		});
		btnViewWilayahKerja.setBounds(227, 85, 160, 23);
		...
		btnViewJabatan.setBounds(43, 85, 160, 23);
